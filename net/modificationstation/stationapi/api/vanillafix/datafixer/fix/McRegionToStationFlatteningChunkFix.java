...
public class McRegionToStationFlatteningChunkFix extends DataFix {
    ...
    static final class Level {
        ...
        private final net.minecraft.unmapped.C_66617355 block_light;
        private final ByteBuffer blocks;
        private final net.minecraft.unmapped.C_66617355 data;
        private final ByteBuffer height_map;
        private final net.minecraft.unmapped.C_66617355 sky_light;

        public Level(Dynamic<?> dynamic) {
            level = dynamic;
            block_light = new net.minecraft.unmapped.C_66617355(DataFixUtils.toArray(dynamic.get("BlockLight").asByteBuffer()));
            blocks = dynamic.get("Blocks").asByteBuffer();
            data = new net.minecraft.unmapped.C_66617355(DataFixUtils.toArray(dynamic.get("Data").asByteBuffer()));
            height_map = dynamic.get("HeightMap").asByteBuffer();
            sky_light = new net.minecraft.unmapped.C_66617355(DataFixUtils.toArray(dynamic.get("SkyLight").asByteBuffer()));
        }
        ...
        public Dynamic<?> transform() {
            ...
            for (int i = 0; i < 32768; i++) {
                ...
                int data = this.data.m_48565066(x, worldY, z);
                if (block > 0 || data > 0) {
            ...
            for (Section section : sections) {
                if (section != null) {
                    ...
                    for (int i = 0; i < 4096; i++) {
                        ...
                        section.setSkyLight(x, y, z, sky_light.m_48565066(x, worldY, z));
                        section.setBlockLight(x, y, z, block_light.m_48565066(x, worldY, z));
                    }
                }
            }
