...
public class StationFlatteningItemStackSchema extends Schema {
    ...
    public static void putState(int oldId, String id, C_74087615 properties) {
        putState(oldId, Util.make(new C_74087615(), tag -> {
            tag.m_91017064("Name", id);
            tag.m_18682924("Properties", properties);
        }));
    }

    public static void putState(int oldId, String id) {
        putState(oldId, Util.make(new C_74087615(), tag -> tag.m_91017064("Name", id)));
    }

    public static void putState(int oldId, C_74087615 tag) {
        String id = tag.m_47517355("Name");
