...
public final class ServerPlayNetworking {
	 ...
	 */
	public static boolean isPlayReady(C_49202226 player) {
	 ...
	 * the given channel.
	 */
	public static boolean isPlayReady(C_49202226 player, NamespacedIdentifier channel) {
	 ...
	 */
	public static void send(C_49202226 player, NamespacedIdentifier channel, PacketPayload payload) {
	 ...
	 */
	public static void send(C_49202226 player, NamespacedIdentifier channel, IOConsumer<PacketBuffer> writer) {
	 ...
	 */
	public static void send(C_49202226 player, NamespacedIdentifier channel, PacketBuffer buffer) {
	 ...
	 * Send a packet to the given player through the given channel.
	 */
	public static void send(C_49202226 player, NamespacedIdentifier channel, byte[] bytes) {
	 ...
	 */
	public static void send(Iterable<C_49202226> players, NamespacedIdentifier channel, PacketPayload payload) {
	 ...
	 */
	public static void send(Iterable<C_49202226> players, NamespacedIdentifier channel, IOConsumer<PacketBuffer> writer) {
	 ...
	 */
	public static void send(Iterable<C_49202226> players, NamespacedIdentifier channel, PacketBuffer buffer) {
	 ...
	 * Send a packet to the given players through the given channel.
	 */
	public static void send(Iterable<C_49202226> players, NamespacedIdentifier channel, byte[] bytes) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(C_49202226 player, NamespacedIdentifier channel, PacketPayload payload) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(C_49202226 player, NamespacedIdentifier channel, IOConsumer<PacketBuffer> writer) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(C_49202226 player, NamespacedIdentifier channel, PacketBuffer buffer) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(C_49202226 player, NamespacedIdentifier channel, byte[] bytes) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(Iterable<C_49202226> players, NamespacedIdentifier channel, PacketPayload payload) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(Iterable<C_49202226> players, NamespacedIdentifier channel, IOConsumer<PacketBuffer> writer) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(Iterable<C_49202226> players, NamespacedIdentifier channel, PacketBuffer buffer) {
	 ...
	 * spam on the client.
	 */
	public static void sendNoCheck(Iterable<C_49202226> players, NamespacedIdentifier channel, byte[] bytes) {
